...
x_training_data, x_testing_data, y_training_data, y_testing_data = train_test_split(x, y, test_size=0.3,random_state=3)
...
X_training_data = np.array(scaled_training)
X_testing_data = np.array(scaled_testing)
